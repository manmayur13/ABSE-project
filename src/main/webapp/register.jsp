  ...
  <body>
	...
	<form action="register" method="post">
				<table border="0" cellpadding="5" cellspacing="5">
					...
					<tr>
						<td>Privileges</td>
						<td><input type="checkbox" name="chk" value="user" /> User</td>
						<td><input type="checkbox" name="chk" value="tech" /> Technical</td>
						<td><input type="checkbox" name="chk" value="nontech"/> Non-Technical</td>
						<td></td>
						<td></td>
