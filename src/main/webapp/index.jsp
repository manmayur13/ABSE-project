...
<html>
  ...
  <body>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><span class="green">Attribute Based</span> Security</a>
        </div>
    ...
    <h3 class="text-center"><marquee>Multiple Attribute-Based Storage Supporting Secure  of Encrypted Data in Cloud</marquee></h3>
    <!-- Thumbnails -->
       <!-- Content -->
